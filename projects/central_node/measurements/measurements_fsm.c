...
static void send_data_to_9160_entry(void *);
...
static const struct smf_state measurement_states[] = {
    ...
    [SEND_DATA_TO_9160] = SMF_CREATE_STATE(send_data_to_9160_entry, send_data_to_9160_run, NULL),
...
static void environment_control_run(void *o)
{
    ...
    static uint8_t measurements_ctr = MEASUREMENTS_SEND_TO_CLOUD_PERIOD_IN_SEC / MEASUREMENT_PERIOD_IN_SEC + 1;
